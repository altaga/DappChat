                    ...
                    this.state.cvc !== "" ?
                        <>
                            ...
                            <div><br /><button
                                ...
                                style={{ fontSize: "1.5rem", height: "6vh", width: "80vw" }} onClick={() => this.showCard()}>{this.state.text}{this.state.icon} </button></div>
                            <hr />
                        </>
                        :
                        <>
                            <div>
                                ...
                                <button
                                    ...
                                    style={{ fontSize: "1.5rem", height: "6vh", width: "80vw" }} onClick={() => this.issueCard()}> Issue Card</button>
                            </div>
                            <br />
                            <hr />
                        </>
                ...
                <div style={{
                    ...
                    <div>
                        <button
                            className='roundButton'
                            disabled={this.state.loading}
                            style={{ fontSize: "1.5rem", height: "6vh", width: "80vw" }} onClick={() => this.state.redirect_url === "" ? this.createSpeiTransfer() : window.open(this.state.redirect_url)}>
                            {
